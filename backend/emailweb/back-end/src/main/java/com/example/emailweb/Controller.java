...
public class Controller {
    ...
    boolean login(@RequestParam String username, @RequestParam String password) throws ParseException, IOException, org.json.simple.parser.ParseException {
        return O.LogIn(username, password);
    }

    @GetMapping("/checkregister")
    boolean regist(@RequestParam String Form) throws ParseException, org.json.simple.parser.ParseException, IOException {
